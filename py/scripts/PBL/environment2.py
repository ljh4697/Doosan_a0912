...
class environment(object):
    ...
    def __init__(self):
        ...
        self.apply_ps_srv = rospy.ServiceProxy('/dsr01a0912/apply_planning_scene', ApplyPlanningScene)
...
###############################################################################
    ...
    def add_mesh(self, mesh_name, position_x = 0, position_y = 0, position_z = 0, orientation_x = 0 , orientation_y = 0, orientation_z = 0, orientation_w = 1, size=(1, 1, 1), frame = "world", timeout=4):
        ...
        mesh_path = '/home/joonhyeok/catkin_ws/src/doosan-robot/doosan-robot/moveit_config_a0912/config/' + mesh_name + '.stl'
...
##########################################################################################################
    ...
    def object_co(self):
        ...
        return table, box, laptop, visualhuman
    ...
    def new_box(self):
        ...
        self.scene.remove_world_object(name='box')
        box,_ = self.add_box(position_x = 0.7, position_y = -0.3, position_z = -0.055, size = (0.1,0.1,0.1), box_name = 'box')
