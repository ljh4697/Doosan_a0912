...
def get_bench_results(task, algo_type:str, num_of_data:int):
    ...
    for i in range(1, 1+num_of_data):
        bench_result = np.load('/home/kim/catkin_ws/src/doosan-robot/dsr_example/py/scripts/PBL/preference_based_learning/results/avoid/batch_active_PBL/avoid-iter10-batch_active_PBL-method{algo_type}-seed{i}.npy'.format(algo_type = algo_type , i = i))
        # bench_result = np.load(task + '/batch_active_PBL/' + f'{task}-iter10-batch_active_PBL-method{algo_type}-seed{i}.npy')
...
def plot_cosine_metric(DPB_cosine_evaluation, DPB_cosine_evaluation_std,
    ...
    plt.tight_layout()
    plt.savefig('/home/kim/catkin_ws/src/doosan-robot/dsr_example/py/scripts/PBL/preference_based_learning/results/saved_graph/{}/{}_cosine_metric.png'.format(task, task))
    plt.show()
...
def plot_simple_regret(opt_simple_reward, opt_simple_reward_std,
    ...
    plt.tight_layout()
    plt.savefig('/home/kim/catkin_ws/src/doosan-robot/dsr_example/py/scripts/PBL/preference_based_learning/results/saved_graph/{}/{}_simple_regret.png'.format(task, task))
...
def plot_cumulative_regret(DPB_cumulative_regret_evaluation, DPB_cumulative_regret_evaluation_std,
    ...
    plt.tight_layout()
    plt.savefig('/home/kim/catkin_ws/src/doosan-robot/dsr_example/py/scripts/PBL/preference_based_learning/results/saved_graph/{}/{}_cumulative_regret.png'.format(task, task))
