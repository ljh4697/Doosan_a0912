...
def parse_args():
    ...
    ap.add_argument("-a", "--algo", type=str, default="DPB", choices=["DPB", "batch_active_PBL"], help="type of algorithm")
    ap.add_argument("-e", "--num-iteration", type=int, default=400, help="# of iteration")
    ap.add_argument("-t", "--task-env", type=str, default="driver", help="type of simulation environment")
    ap.add_argument("-b", "--num-batch", type=int, default=10, help="# of batch")
