...
class PickNPlaceTutorial():
    ...
    def add_box_2(self, frame = 'world', orientation_x = 0 , orientation_y = 0, orientation_z = 0, orientation_w = 1, position_x = 0, position_y = 0, position_z = 0, box_name = 'box', size = (0.1,0.1,0.1), timeout=4 ):
    ...
    def add_objects(self):
        ...
        self.add_box(name='table0', pose_stamp=table0, size=(0.6, 0.8, 0.4))
        self.object_info['table0'] = table0
    

        # table,_ = self.add_box_2(position_x = 1.025, position_z = -0.465, size = (1.2,1.4,0.72), box_name = 'table')
        table = geometry_msgs.msg.PoseStamped()
        table.header.frame_id = self.robot_group.get_planning_frame()
        table.pose.position.x =1.025
        table.pose.position.y =0
        table.pose.position.z =-0.465
        table.pose.orientation.w = 1.0      
        self.add_box(name='table', pose_stamp=table, size=(1.2,1.4,0.72))
